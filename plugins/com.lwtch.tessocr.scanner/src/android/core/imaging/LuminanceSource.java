...
public abstract class LuminanceSource {
     ...
     * value. It is preferable for implementations of this method to only fetch this
     * row rather than the whole image, since no 2D Readers may be installed and
     * getMatrix() may never be called.
     *
     * @param y   The row to fetch, which must be in [0,getHeight())
     * @param row An optional preallocated array. If null or too small, it will be
     ...
     *
     * @return A row-major 2D array of luminance values. Do not use result.length as
     *         it may be larger than width * height bytes on some platforms. Do not
     *         modify the contents of the result.
     */
