...
import com.lwtch.tessocr.scanner.ImageDialog;
import com.lwtch.tessocr.scanner.Tools;
...
public class TessAsyncEngine extends AsyncTask<Object, Void, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        ImageDialog.New().addBitmap(bmp).addTitle(s).show(context.getFragmentManager(), TAG);
