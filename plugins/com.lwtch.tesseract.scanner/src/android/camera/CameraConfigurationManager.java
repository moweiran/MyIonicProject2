 ...
 */
package com.lwtch.tesseract.scanner.camera;
...
public final class CameraConfigurationManager {
    ...
    public void initFromCameraParameters(Camera camera) {
        ...
        WindowManager manager = (WindowManager) TesseractScanner.sAppContext.getSystemService(Context.WINDOW_SERVICE);
    ...
    public void setDesiredCameraParameters(Camera camera) {
        ...
        // if (safeMode) {
        // Log.w(TAG, "In camera config safe mode -- most settings will not be
        // honored");
        // }
